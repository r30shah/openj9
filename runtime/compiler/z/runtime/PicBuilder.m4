...
ZZ ==================================================================
ZZ  PICBuilder routine - _interfaceCallHelperReadOnlyMultiSlots
ZZ ==================================================================
   START_FUNC(_interfaceCallHelperReadOnlyMultiSlots,ifCHRM)

LABEL(_interfaceCallHelperReadOnlyMultiSlots_BODY)
   AHI_GPR  J9SP,-(3*PTR_SIZE)
   ST_GPR   r1,(2*PTR_SIZE)(J9SP)
   ST_GPR   r2,PTR_SIZE(J9SP)
   ST_GPR   r3,0(J9SP)
...
ZZ Load address of the interface call data block into the rEP
   LR_GPR   rEP,r14
   AGF      rEP,eq_InterfaceCallHelperReadOnly_Data(rEP)
...
ZZ Check if the we are updating slot with same class, in such case, we are done.
   ...
   CL_GPR      r9,eq_InterfaceCallHelperTotalPICSlotSize(rEP)
...
ZZ zLinux
   ...
   END_FUNC(_interfaceCallHelperReadOnlyMultiSlots,ifCHRM,8)
