...
J9::Z::PrivateLinkage::buildDirectCall(TR::Node * callNode, TR::SymbolReference * callSymRef,
   ...
   if (callSymbol->isHelper()
      ...
      generateS390CompareAndBranchInstruction(cg(), TR::InstOpCode::getCmpRegOpCode(), callNode, j9classReg, static_cast<int64_t>(SIOOBclazz), TR::InstOpCode::COND_BNE, skipTrap, false, false);
