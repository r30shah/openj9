    ...
    bool trace)
{
    ...
    // maximumFrequency seen in this method's profiling compilation. While
    // making inlining decisions (normalizeForCaller set to false) this will be
    // used to compute the outterProfiledFrequency in from this method.
