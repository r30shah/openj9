...
#define J9OBJECT_U16_LOAD(vmThread, object, offset) ((U_16)J9VMTHREAD_JAVAVM(vmThread)->memoryManagerFunctions->j9gc_objaccess_mixedObjectReadU16((vmThread), (j9object_t)(object), (offset), 0))
#define J9OBJECT_U16_STORE(vmThread, object, offset, value) (J9VMTHREAD_JAVAVM(vmThread)->memoryManagerFunctions->j9gc_objaccess_mixedObjectStoreU16((vmThread), (j9object_t)(object), (offset), (U_16)(value), 0))
#define J9OBJECT_U8_LOAD(vmThread, object, offset) ((U_8)J9VMTHREAD_JAVAVM(vmThread)->memoryManagerFunctions->j9gc_objaccess_mixedObjectReadU8((vmThread), (j9object_t)(object), (offset), 0))
#define J9OBJECT_U8_STORE(vmThread, object, offset, value) (J9VMTHREAD_JAVAVM(vmThread)->memoryManagerFunctions->j9gc_objaccess_mixedObjectStoreU8((vmThread), (j9object_t)(object), (offset), (U_8)(value), 0))
...
#if defined(J9VM_OPT_VALHALLA_COMPACT_LAYOUTS)
#define J9OBJECT_I16_LOAD(vmThread, object, offset) ((I_16)J9VMTHREAD_JAVAVM(vmThread)->memoryManagerFunctions->j9gc_objaccess_mixedObjectReadI16((vmThread), (j9object_t)(object), (offset), 0))
#define J9OBJECT_I16_STORE(vmThread, object, offset, value) (J9VMTHREAD_JAVAVM(vmThread)->memoryManagerFunctions->j9gc_objaccess_mixedObjectStoreI16((vmThread), (j9object_t)(object), (offset), (I_16)(value), 0))
#define J9OBJECT_I8_LOAD(vmThread, object, offset) ((I_8)J9VMTHREAD_JAVAVM(vmThread)->memoryManagerFunctions->j9gc_objaccess_mixedObjectReadI8((vmThread), (j9object_t)(object), (offset), 0))
#define J9OBJECT_I8_STORE(vmThread, object, offset, value) (J9VMTHREAD_JAVAVM(vmThread)->memoryManagerFunctions->j9gc_objaccess_mixedObjectStoreI8((vmThread), (j9object_t)(object), (offset), (I_8)(value), 0))
#endif /* defined(J9VM_OPT_VALHALLA_COMPACT_LAYOUTS) */
#if defined (J9VM_ENV_DATA64)
...
#if defined(J9VM_OPT_VALHALLA_COMPACT_LAYOUTS)
#define J9OBJECT_U16_LOAD(vmThread, object, offset) ((void)0, *(U_16*)((U_8*)(object) + (offset)))
#define J9OBJECT_U16_STORE(vmThread, object, offset, value) ((void)0, (*(U_16*)((U_8*)(object) + (offset)) = (value)))
#define J9OBJECT_U8_LOAD(vmThread, object, offset) ((void)0, *((U_8*)(object) + (offset)))
#define J9OBJECT_U8_STORE(vmThread, object, offset, value) ((void)0, (*((U_8*)(object) + (offset)) = (value)))
#endif /* defined(J9VM_OPT_VALHALLA_COMPACT_LAYOUTS) */
...
#if defined(J9VM_OPT_VALHALLA_COMPACT_LAYOUTS)
#define J9OBJECT_I16_LOAD(vmThread, object, offset) ((void)0, *(I_16*)((U_8*)(object) + (offset)))
#define J9OBJECT_I16_STORE(vmThread, object, offset, value) ((void)0, (*(I_16*)((U_8*)(object) + (offset)) = (value)))
#define J9OBJECT_I8_LOAD(vmThread, object, offset) ((void)0, *(I_8*)((U_8*)(object) + (offset)))
#define J9OBJECT_I8_STORE(vmThread, object, offset, value) ((void)0, (*(I_8*)((U_8*)(object) + (offset)) = (value)))
#endif /* defined(J9VM_OPT_VALHALLA_COMPACT_LAYOUTS) */
...
#if defined(J9VM_OPT_VALHALLA_COMPACT_LAYOUTS)
#define J9OBJECT_U16_LOAD_VM(vmThread, object, offset) ((void)0, *(U_16*)((U_8*)(object) + (offset)))
#define J9OBJECT_U16_STORE_VM(vmThread, object, offset, value) ((void)0, (*(U_16*)((U_8*)(object) + (offset)) = (value)))
#define J9OBJECT_U8_LOAD_VM(vmThread, object, offset) ((void)0, *((U_8*)(object) + (offset)))
#define J9OBJECT_U8_STORE_VM(vmThread, object, offset, value) ((void)0, (*((U_8*)(object) + (offset)) = (value)))
#endif /* defined(J9VM_OPT_VALHALLA_COMPACT_LAYOUTS) */
...
#if defined(J9VM_OPT_VALHALLA_COMPACT_LAYOUTS)
#define J9OBJECT_I16_LOAD_VM(vmThread, object, offset) ((void)0, *(I_16*)((U_8*)(object) + (offset)))
#define J9OBJECT_I16_STORE_VM(vmThread, object, offset, value) ((void)0, (*(I_16*)((U_8*)(object) + (offset)) = (value)))
#define J9OBJECT_I8_LOAD_VM(vmThread, object, offset) ((void)0, *(I_8*)((U_8*)(object) + (offset)))
#define J9OBJECT_I8_STORE_VM(vmThread, object, offset, value) ((void)0, (*(I_8*)((U_8*)(object) + (offset)) = (value)))
#endif /* defined(J9VM_OPT_VALHALLA_COMPACT_LAYOUTS) */
